...
CONSTANCE_CONFIG = {
    ...
    'PLANS_PAGE_CONTENT': (
        "Эта страница еще в разработке",
        'Тут необходимо указать текст, который будет отображаться на странице "Наши планы"',
        'editable_content'
    ),
    ...
    'SMS_HELP_PAGE_CONTENT': (
        "Эта страница еще в разработке",
        'Тут необходимо указать текст, который будет отображаться на странице "Помощь приюту с помощью sms"',
        'editable_content'
    ),
    'MEDIA_PAGE_CONTENT': (
        "Эта страница еще в разработке",
