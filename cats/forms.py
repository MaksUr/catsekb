...
from cats.cats_constants import ANIMAL_UPDATED, ANIMAL_CREATED, ANIMAL_BIRTHDAY_PRECISION, ANIMAL_KEY_UPDATED_HELP_TEXT, \
    ...
    ANIMAL_IMAGE_FAVOURITE, ANIMAL_IMAGE_BACKGROUND, ANIMAL_IMAGE_KEY_BACKGROUND_HELP_TEXT, \
...
class AnimalForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            ANIMAL_SHELTER_DATE, ANIMAL_VIDEO,
        ]
        help_texts = {
            ...
            'project': 'Выберите приют, к которому принаджежит питомец',
            ANIMAL_DESCRIPTION: ANIMAL_KEY_DESCRIPTION_HELP_TEXT,
            ANIMAL_LOCATION_STATUS: ANIMAL_KEY_LOCATION_STATUS_HELP_TEXT,
            ANIMAL_TAG: 'Хештег для instagram. Символ "#" подставляется автоматически. Пример заполнения: "Смурфик"',
