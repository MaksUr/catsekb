...
from cats.constants import GROUP_INSTANCE_ALL_NAME, ANIMAL_GROUP, ANIMAL_NAME, GROUP_INSTANCE_ALL_ID, AGE_DISTANCE, \
    ANIMAL_DATE_OF_BIRTH, GROUP_NAME, DJ_PK, ANIMAL_LOCATION_STATUS_DEAD, ANIMAL_LOCATION_STATUS_SHELTER, \
    ANIMAL_LOCATION_STATUS_HOME, ANIMAL_LOCATION_STATUS, GROUP_ID, ANIMAL_SEX
